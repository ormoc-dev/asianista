...
<div class="stats-grid">
    ...
    <a href="{{ route('admin.lessons.index') }}" class="stat-card">
    ...
    <a href="{{ route('admin.gamification') }}" class="stat-card">
    ...
    <a href="{{ route('admin.target-audience') }}" class="stat-card">
...
<div class="card">
    ...
    <div class="card-body">
        <div style="display: flex; gap: 12px; flex-wrap: wrap;">
            ...
            <a href="{{ route('admin.gamification') }}" class="btn btn-secondary">
